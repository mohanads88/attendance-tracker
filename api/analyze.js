...
## تنبيهات القراءة — هذه الأزواج تتشابه بصرياً في الخطوط الرقمية

**أزواج الحروف المتشابهة:**
| الحرف | يُخطأ أحياناً بـ | أمثلة على الخطأ |
|---|---|---|
| ع (عين) | ح (حاء) | عسيري/حسيري — عمر/حمر |
| ش (شين) | ث (ثاء) | الشمراني/الثمراني — شائم/ثائم |
| ح (حاء) | ج (جيم) | الدلبحي/الدلبجي |
| ي (ياء) | و (واو) | السياري/السواري |

**تنبيهات خاصة:**
- "آل" (كما في آل حيدر) هو جزء من اسم العائلة — لا تكتبها "ال"
- الذييب تحتوي على ياءين — لا تحذف واحدة
- العقل ≠ العقيل — شخصان مختلفان تماماً

**القاعدة:** اكتب الاسم كما هو في اللقطة — لا تصحّح ولا تخمّن.
